...
con = DBcon.createconnection();
    ...
    String query = "select * from etraining where Trainingid = '" + id + "'";
...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 24%;"><h1><b>Edit Training</b></h1></div>
    <div class="card-body1" style="padding: 1.5rem; margin: 11% 0 0 20%; width: 26%;" >
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          <div class="row">
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form id="employeeForm" action="updateTrainingServlet" method="post">
       		<% while(rs.next()){ %>
            <div class="form-group" >
                <label for="name">Training ID :</label>
                <input type="text" id="id" name="idd" value ="<%=  rs.getString("TrainingId")%>" required readonly>
            </div>
            <div class="form-group" >
                <label for="age">Training Name :</label>
                <input type="text" id="name" name="name"  value="<%=  rs.getString(2)%>"required>
            </div>
			<label for="address" style="float:left">Description :&emsp; </label>
            <div class="form-group">
                
                <textarea  id="name" name="description"  rows="5" cols="40" required><%=  rs.getString(3)%></textarea>
            </div>
            
            
            
                <button type="submit" style="--color: #cfbab6; position:absolute; left:71%; top:97%" ><span>Update</span><i></i></button>
            <%} %>
        </form>
              </div>
             </div> 
