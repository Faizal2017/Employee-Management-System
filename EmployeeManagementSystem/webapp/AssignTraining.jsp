...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    con = DBcon.createconnection();
        ...
        String query = "select EmpId, Name, Department from permenant_employee where EmpId='"+id+"'";
        
        
        String query1 = "select Name from etraining";
...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 27%;"><h1><b>Assign Training</b></h1></div>
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          <div class="row">
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form  action="TrainingServelet" method="post">
       
            	<% rs = stmt.executeQuery(query); 
                while(rs.next()) { %>
                    <label for="EID">Employee ID</label><br>
                    <input type="text" id="Emp_ID" name="Emp_ID" value= <%=rs.getString(1) %> readonly><br><br>
                    <label for="name">Name</label><br>
                    <input type="text" id="name" name="name" value=<%=rs.getString(2)%> readonly><br><br>
                    <label for="dep">Department</label><br>
                    <input type="text" id="dep" name="dep" value=<%=rs.getString(3)%> readonly><br><br>
                    <%} %>
                    <label for="tname">Training Name</label><br>
                    <select name="tname">
        				<%  
                ...
                <button type="submit" style="--color: #cfbab6; position:absolute; left:71%; top:97%" ><span>Assign</span><i></i></button>
