	...
	try {
	    ...
	    String query = "select * from permenant_employee where EmpId = '" + id + "';";
	...
	<head>
	    ...
	    <title>Edit Permanent Employee</title>
	...
	<div class="wrapper">
	    ...
	    <div class="title" style="margin: 7% 0 0 24%;"><h1><b>Edit Permanent Employee</b></h1></div>
