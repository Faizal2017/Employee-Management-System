...
<%@page import="com.controllers.MakePaymentServelet"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
    
    <%ArrayList<Comparable> arr = (ArrayList<Comparable>)request.getAttribute("arr");
    %>
...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 24%;"><h1><b>Payment Summary</b></h1></div>
          ...
          <div class="row">
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form action="ConfirmPayServlet" method="post">
                    <div class="form" >
                    <label for="EID">Employee ID : </label> &emsp;
                    <input type="text" id="eid" name="Emp_ID" style="border: 0; background-color: #fff;" value=<%=arr.get(0)%>  readonly><br><br>
                    <label for="salary">Monthly Salary : </label>&emsp;
                    <input type="text" id="salary" name="salary" style="border: 0; background-color: #fff;" value=<%=arr.get(1)%>  readonly><br><br>
                    <label for="month">Month : </label>&emsp;
                    <input type="text" id="month" name="month" style="border: 0; background-color: #fff;" value=<%=arr.get(2)%>  readonly><br><br>
                    <label for="leave">Extra leave : </label>&emsp;
                    <input type="number" id="leave" name="leave" style="border: 0; background-color: #fff;" value=<%=arr.get(3)%>  readonly><br><br>
                    <label for="bonus">Bonus : </label>&emsp;
                    <input type="number" id="bonus" name="bonus" style="border: 0; background-color: #fff;" value=<%=arr.get(4)%>  readonly> %<br><br>
                    <label for="netSal">Net Salary : </label>&emsp;
                    <input type="text" id="netSal" name="netSal" style="border: 0; background-color: #fff;" value=<%=arr.get(7)%>  readonly><br><br>
                    <label for="acc">Account : </label>&emsp;
                    <input type="text" id="acc" name="acc" style="border: 0; background-color: #fff;" value="${arr.get(5)}"  readonly><br>
                    <a>Employee salary is deducted by <%=arr.get(6)%> % for each extra leave</a><br><br>
                ...
                <button type="submit" style="--color: #cfbab6; position:absolute !important; left:76%; top:93%" ><span>Pay</span><i></i></button>
