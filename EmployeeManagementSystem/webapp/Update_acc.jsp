...
<%@page import="com.controllers.UpdateAccServelet"%>
...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 30%;"><h1><b>Update Account</b></h1></div>
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          <div class="row">
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form  action="UpdateAccServelet" method="post">
    ...
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <div class="relative">
        <input name="Emp_ID"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" value= "<%=rs.getString(1) %>" readonly>
    ...
    <div class="w-full md:w-1/2 px-3">
      ...
      <input name="acc_no"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" value= <%=rs.getString(2) %> required>
    </div>
  </div>
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <input name="bank" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" value= "<%=rs.getString(3) %>" required>
    </div>
    ...
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <input name="branch" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city" type="text" value= "<%=rs.getString(4) %>" required>
    </div>
    
  
  </div>
                    <input type="hidden" id="old_acc" name="old_acc" value= <%=rs.getString(2) %> >
         
                <button type="submit" style="--color: #cfbab6 !important; position:absolute !important; left:79% !important; top:130% !important" ><span>Update</span><i></i></button>
