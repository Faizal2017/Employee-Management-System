...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 27%;"><h1><b>Add Department</b></h1></div>
          ...
          <div class="row">
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form  action="AddDepartmentServlet" method="post">
            	...
            	<label for="acc_no">Department ID</label><br>
                    <input type="text" id="depID" name="depID" required><br><br>
                    <label for="bank">Department Name</label><br>
