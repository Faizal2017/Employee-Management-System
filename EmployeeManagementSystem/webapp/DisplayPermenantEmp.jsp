...
<head>
    ...
    <script>
			$(document).ready(function(){
				...
				{
					$.ajax({
						url:"search/permenetEmpList.jsp",
						method:"post",
						data:{query:query},
    ...
    <title>Permanent Employee List</title>
  </head>
  <body>
  <div class="wrapper">
        <!-- Sidebar -->
    ...
    <div class="title" style="margin: 7% 0 0 25%;"><h1><b>Permanent Employee List</b></h1></div>
    <div class="card-body1" style="padding: 1.5rem; margin:11% 0 0 4%; width:75%;" >
      <div class="input-group" style= "padding : 0 2px 0 70%; margin: 0 0 8px 0;">
...
<% 
    if( request.getAttribute("name4") != null){
    %><script>
    $(document).ready(function() {
        $.bootstrapGrowl('Login Successfully !!', {
            type: 'success',
            offset: {from: 'top', amount: 75},
            align: 'right',
            width: 350,
