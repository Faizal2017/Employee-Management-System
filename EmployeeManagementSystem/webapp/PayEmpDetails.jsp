...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    int extraleave = (Integer)request.getAttribute("extraleave");
    %>
...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 24%;"><h1><b>Pay Salary</b></h1></div>
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          <div class="row">
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form action="MakePaymentServelet" method="post">
                    <%ResultSet rs = (ResultSet)request.getAttribute("rs");
                    while(rs.next()){%>
                    <label for="EID">Employee ID</label> &emsp;
                    <input type="text" id="eid" name="Emp_ID" value= <%=rs.getString(1)%> readonly><br><br>
                    <label for="salary">Monthly Salary</label>&emsp;
                    <input type="text" id="salary" name="salary" value= <%=rs.getString(2) %> readonly><br><br>
                    <label for="month">Select Month</label>&emsp;
                    <select name="month">
        				<% }
                    ...
                    <input type="number" id="leave" name="leave" value=<%=extraleave%> readonly>  Days<br><br>
                    <label for="bonus">Bonus</label>&emsp;
                    <input type="number" id="bonus" name="bonus" value=0 min="0" max="100" required>  %<br><br>
                    <label for="acc">Select Account</label>&emsp;
                ...
                <button type="submit" style="--color: #cfbab6; position:absolute; left:71%; top:97%" ><span>Pay</span><i></i></button>
