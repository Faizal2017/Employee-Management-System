...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 27%;"><h1><b>Update Department</b></h1></div>
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form  action="UpdateDepServlet" method="post">
            	...
            	<label for="depID">Department ID</label><br>
                    <input type="text" id="depID" name="depID" value= <%=depID%> readonly><br><br>
                    <label for="depName">Department Name</label><br>
                    <input type="text" id="depName" name="depName" value= "<%=depName%>" required><br><br>
