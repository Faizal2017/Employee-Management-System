...
<%	
    ...
    try {
        ...
        String query = "select * from etraining";
...
<head>
  ...
  <div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 33%;"><h1><b>Training List</b></h1></div>
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          ...
          <thead>
            <tr role="row" class="table-warning">
              ...
              <th class="sorting" style="width: 74.2px;">Training ID</th>
              <th class="sorting" style="width: 50.2px;">Name</th>
              <th class="sorting" style="width: 74.2px;">Description</th>
          ...
          <tr role="row" class="odd">
                ...
                <td class="align-middle text-center">
                  <a href="editTraining.jsp?idd=<%=rs.getString(1)%>" class="btn btn-info btn-circle" onclick="return confirm('Do you Want to Edit ?')">
                    <span class="icon text-white" title="Edit">
                      <i class="fa-solid fa-pen-to-square"></i>
                    </span>
                  </a> |
                  <a href="deleteTrainingservlet?Id=<%=rs.getString(1)%>" class="btn btn-danger btn-circle" onclick="return confirm('Do you Want to Delete ?')">
