...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 27%;"><h1><b>Create Logins</b></h1></div>
    ...
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <div class="relative">
      	 <input name="idd"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" value ="<%= id %>" type="text" readonly >
    ...
    <div class="w-full md:w-1/2 px-3">
      ...
      <input name="name"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" required>
    </div>
    ...
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <input name="password" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" required>
    </div>
