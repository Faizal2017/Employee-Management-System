...
try {
    ...
    String query = "select * from temporary_employee where EmpId = '" + id + "'";
...
<head>
    ...
    <title>Edit Temporary Employee</title>
...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 24%;"><h1><b>Edit Temporary Employee</b></h1></div>
      ...
      <div class="table table-striped" >
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
         ...
         <% while(rs.next()){ %>
            ...
            <input name="id" type="hidden" value="<%=  rs.getString("EmpId") %>">
