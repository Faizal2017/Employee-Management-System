        ...
        <div class="row">
          ...
          <thead>
            <tr role="row" class="table-warning">
              ...
              <th class="sorting" style="width: 58.2px;">DeptName</th>
...
%>
                ...
                <td class="align-middle text-center">
                  <a href="AttendanceHistory.jsp?EMPID=<%=resultSet.getString("EmpId") %>" class="btn btn-info btn-circle">
...
<%
	...
	%>
			                ...
			                <td class="align-middle text-center">
			                  <a href="AttendanceHistory.jsp?EMPID=<%=resultSet1.getString("EmpId") %>" class="btn btn-info btn-circle">
			                    <span class="icon text-white" title="Edit">
			                      <i class="fa fa-search" aria-hidden="true"></i>
			                    </span>
			                  </a>
