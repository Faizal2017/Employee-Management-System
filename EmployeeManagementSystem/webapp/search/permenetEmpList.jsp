...
%>
                ...
                <td class="align-middle text-center">
                  <a href="EditPermenantEmp.jsp?idd=<%=resultSet.getString("EmpId")%>" class="btn btn-info btn-circle" onclick="return confirm('Do you Want to Edit ?')">
                    <span class="icon text-white" title="Edit">
                      <i class="fa-solid fa-pen-to-square"></i>
                    </span>
                  </a> |
                  <a href="deleteEmployeeServlet?Id=<%=resultSet.getString(2)%>" class="btn btn-danger btn-circle" onclick="return confirm('Do you Want to Delete ?')">
