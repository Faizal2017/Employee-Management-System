...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 24%;"><h1><b>Add Training</b></h1></div>
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          <div class="row">
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form id="employeeForm" action="AddTrainingServlet" method="post">
            ...
            <div class="form-group">
                ...
                <textarea  id="name" name="description"  rows="5" cols="40" required></textarea>
            </div>
            
            
            
                <button type="submit" style="--color: #cfbab6; position:absolute; left:71%; top:97%" ><span>Add</span><i></i></button>
