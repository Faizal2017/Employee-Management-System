...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  <%	
  	...
  	ResultSet rs = DepartmentDAO.Dep_Details();
...
<head>
  ...
  <div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 33%;"><h1><b>Department Details</b></h1></div>
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          <div class="row">
            <div class="col-sm-12 col-md-6" style="left: 53%; ">
     		...
     		<div class="row">
            <div class="col-sm-12">
            <div class="table-container" style="width: 104%;">
          ...
          <thead>
            <tr role="row" class="table-warning">
              ...
              <th class="sorting" style="width: 74.2px;">Department ID</th>
              <th class="sorting" style="width: 50.2px;">Department Name</th>
              <th class="sorting" style="width: 50.2px;">Actions</th>
          ...
          <tr role="row" class="odd">
                ...
                <td class="align-middle text-center">
                  <a href="UpdateDepServlet?depID=<%=rs.getString(1) %>&depName=<%=rs.getString(2) %>" class="btn btn-info btn-circle" onclick="return confirm('Do you Want to Edit ?')">
                    <span class="icon text-white" title="Edit">
                      <i class="fa-solid fa-pen-to-square"></i>
                    </span>
                  </a> |
                  <a href="DeleteDepServlet?depID=<%=rs.getString(1) %>&depName=<%=rs.getString(2) %>" class="btn btn-danger btn-circle" onclick="return confirm('Do you Want to Delete ?')">
