...
<html lang="en">
  ...
  <div class="wrapper">
    ...
    <div class="title"><h1><b>ATTENDANCE</b></h1></div>
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          <div class="row">
            <div class="col-sm-12 col-md-6" style="left: 53%; ">
             ...
             <form action="AttendanceServelet" method="post">
            <div id="result"> </div> 
			<div style="clear:both"></div>
        <button  type ="submit" style="--color: #cfbab6; position:absolute; left:32%;top: 10%;"><span>UPDATE ATTENDANCE</span><i></i></button>
			</form>
            </div>
          </div>
    </div>
