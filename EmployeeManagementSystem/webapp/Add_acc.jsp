...
<%@page import="com.dao.GetDAO"%>
<%@page import="java.sql.ResultSet"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
      <%	
  	
  	ResultSet rs = GetDAO.PerEmp();
      ResultSet rs1= GetDAO.TempEmp();
...
<div class="wrapper">
    ...
    <div class="title" style="margin: 7% 0 0 27%;"><h1><b>Add Account Detail</b></h1></div>
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
          <div class="row">
            ...
            <div class="table-container" style="overflow-x: clip; max-height: 370px">
              ...
              <form  action="AccountServelet" method="post">
    ...
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <div class="relative">
        <select  name="Emp_ID" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
          <%  while(rs.next()){ %>
    ...
    <div class="w-full md:w-1/2 px-3">
      ...
      <input name="acc_no"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" required>
    </div>
  </div>
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <input name="bank" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" required>
    </div>
    ...
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <input name="branch" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city" type="text" required>
    </div>
                ...
                <button type="submit" style="--color: #cfbab6 !important; position:absolute !important; left:84% !important; top:130% !important" ><span>Add</span><i></i></button>
